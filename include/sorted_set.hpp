...
///
/// int main() {
///     sorted_set::SortedSet<int> s{3, 1, 3};
///     assert(s.size() == 2);
/// }
/// @endcode
...
public:
    ...
    ///
    /// int main() {
    ///     sorted_set::SortedSet<int> s(std::vector<int>{3, 1, 3});
    ///     assert(s.size() == 2);
    /// }
    /// @endcode
    ...
    ///     sorted_set::SortedSet<int> s(values.begin(), values.end());
    ///     assert(s.size() == 2);
    /// }
    /// @endcode
    ...
    ///
    /// int main() {
    ///     sorted_set::SortedSet<int> s{1, 3, 5};
    ///     assert(s.size() == 3);
    /// }
    /// @endcode
    ...
    ///
    /// int main() {
    ///     const sorted_set::SortedSet<int> s{1, 3, 5};
    ///     assert(s.at(0) == 1);
    ///     assert(s.at(-1) == 5);
    ///     bool caught = false;
    ...
    ///
    /// int main() {
    ///     sorted_set::SortedSet<int> s{1, 3, 3};
    ///     assert(s.count(3) == 1);
    ///     assert(s.count(9) == 0);
    /// }
    /// @endcode
